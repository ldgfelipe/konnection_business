...
import { A as ApplicationLogo } from "./ApplicationLogo-DB5hZ_I6.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        href: _ctx.route("empresas"),
        active: _ctx.route().current("empresas")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Empresas `);
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        href: _ctx.route("productos"),
        active: _ctx.route().current("productos")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Productos `);
      ...
      if (_ctx.$page.props.auth.user) {
        ...
        _push(ssrRenderComponent(_sfc_main$4, {
          ...
          content: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(ssrRenderComponent(_sfc_main$3, {
                href: _ctx.route("perfilEmpresas")
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(` Mi Empresas `);
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          class: "inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-gray-800 bg-white hover:bg-gray-100"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(` Registrarse `);
      ...
      _push(`</div><div class="-me-2 flex items-center sm:hidden"><button class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out"><svg class="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24"><path class="${ssrRenderClass({
      ...
      _push(`</div>`);
      if (_ctx.$page.props.auth.user) {
        _push(`<div class="pt-4 pb-1 border-t border-gray-200"><div class="px-4"><div class="font-medium text-base text-gray-800">${ssrInterpolate((_a = _ctx.$page.props.auth.user) == null ? void 0 : _a.name)}</div><div class="font-medium text-sm text-gray-500">${ssrInterpolate((_b = _ctx.$page.props.auth.user) == null ? void 0 : _b.email)}</div></div><div class="mt-3 space-y-1">`);
        _push(ssrRenderComponent(_sfc_main$1, {
          href: _ctx.route("profile.edit")
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
        ...
        _push(`<div class="pt-4 pb-1 border-t border-gray-200"><div class="mt-3 space-y-1 px-4">`);
        _push(ssrRenderComponent(_sfc_main$1, {
          href: _ctx.route("login")
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
