...
import { _ as _sfc_main$2 } from "./GuestLayout-Co6DtfHS.js";
import { _ as _sfc_main$3, a as _sfc_main$4, b as _sfc_main$5 } from "./TextInput-vfWly7IM.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$2, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Inicia Sesión" }, null, _parent2, _scopeId));
            if (__props.status) {
            ...
            _push2(`<span class="ms-2 text-sm text-gray-600"${_scopeId}>Recuerdame</span></label></div><div class="flex items-center justify-end mt-4"${_scopeId}>`);
            if (__props.canResetPassword) {
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(` No recuerdo mi contraseña `);
                  } else {
                    return [
                      createTextVNode(" No recuerdo mi contraseña ")
                    ];
                  }
                }),
                _: 1
            ...
            return [
              createVNode(unref(Head), { title: "Inicia Sesión" }),
              ...
              createVNode("form", {
                ...
                createVNode("div", { class: "block mt-4" }, [
                  createVNode("label", { class: "flex items-center" }, [
                    ...
                    createVNode("span", { class: "ms-2 text-sm text-gray-600" }, "Recuerdame")
                  ])
                ]),
